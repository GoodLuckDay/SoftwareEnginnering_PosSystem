...
public class Item_Detail extends JFrame {
	...
	public Item_Detail() {
		...
		change.setFont(new Font("����", Font.PLAIN, 24));
		...
		delete.setFont(new Font("����", Font.PLAIN, 24));
		...
		item_num.setFont(new Font("����", Font.PLAIN, 30));
		panel.add(item_num);
		
		text_num = new JTextField();
		text_num.setHorizontalAlignment(SwingConstants.RIGHT);
		text_num.setText("1");
		text_num.setFont(new Font("����", Font.PLAIN, 20));
		panel.add(text_num);
